...
def build_fakturoid_url(base_url: str, slug: str, invoice_id: int) -> str:
    ...
    return f"{base_url}/i/{slug}/{invoice_id}"
...
def summary_to_output(summary: ClockifySummary) -> dict[str, Any]:
    ...
    for entry in summary.entries:
        ...
        output["by_project"].setdefault(project_name, 0.0)
        output["by_project"][project_name] = round(
            output["by_project"][project_name] + entry.duration_hours,
            2,
        )
