...
Claude: Fetches hours from Clockify for the current month...
        Found 10 hours across 2 projects.
        Rate: 100 CZK/hr → Subtotal: 1,000 CZK + VAT 21% = 1,210 CZK
        Client: Acme Corp

        Create this invoice?
User: yes
Claude: Proforma created (#FV-2026-001). Finalizing...
        Invoice fired. Sending Slack notification to #invoicing...
        Done. Invoice FV-2026-001 issued for 1,210 CZK.
```
